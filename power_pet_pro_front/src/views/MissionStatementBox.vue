  ...
  <section class="hero is-fullheight ">
    <div class="hero-body">
      <div class="container has-text-centered">
        ...
        <hr />
        <p class="subtitle">Please modify or add your Mission Statement below</p>
           ...
           <div class="column is-5">
             <div class="box has-text-centered">
               ...
               <div v-if="mission_statement">
                 ...
                 <button class="button is-danger is-outlined" @click="activate_delete_modal = !activate_delete_modal">
              ...
              <figure class="image is-128x128 is-inline-block">
               ...
               <div class="field">
                <div class="control has-icons-left">
                  <textarea class="textarea" placeholder="Mission Statement" v-model="mission_statement"></textarea>
                </div>
              </div>
  ...
  <div class="modal is-centered" :class="{'is-active':activate_modal, 'is-clipped':activate_modal}">
    ...
    <div class="modal-card">
      <header class="modal-card-head">
        <p class="modal-card-title">Confirm Posting or Updating Mission Statement</p>
        <button class="delete" aria-label="close" @click="activate_modal=false"></button>
      </header>
      <section class="modal-card-body">
        <div class="box">
          New Mission Statement: "{{ mission_statement }}"
        </div>
      </section>
      <footer class="modal-card-foot is-centered">
        <button class="button is-success" @click="confirm_submit_mission_statement()">Save Changes</button>
   ...
   <div class="modal is-centered" :class="{'is-active':activate_delete_modal, 'is-clipped':activate_delete_modal}">
    ...
    <div class="modal-card">
      ...
      <footer class="modal-card-foot is-centered">
        <button class="button is-danger" @click="confirm_delete_mission_statement()">Delete Message</button>
...
export default{
  ...
  methods:{
    confirm_submit_mission_statement(){
      if(this.mission_statement){
        ...
        if(this.empty_mission_statement){
          ...
          axios.post('admin_panel/our_mission/add_mission_statement/',{
            ...
            toast({
              message: "Submitted the mission statement. Please refresh your page.",
              type: "is-success",
              dismissible: true,
              pauseOnHover: true,
          ...
          axios.put('admin_panel/our_mission/add_mission_statement/',{
            main_statement: this.mission_statement
          },{
            headers: {Authorization: `Bearer ${this.accessToken}`}
          }).then(()=>{
            this.activate_modal = !this.activate_modal
            toast({
              message: "Updated the mission statement. Please refresh your page.",
              type: "is-success",
              dismissible: true,
              pauseOnHover: true,
              duration: 6000, // milliseconds
    ...
    confirm_delete_mission_statement(){
       axios.delete('admin_panel/our_mission/add_mission_statement/', {
         headers: {Authorization: `Bearer ${this.accessToken}`}
       }).then(()=>{
