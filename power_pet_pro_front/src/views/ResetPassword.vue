            ...
            <form class="box" @submit.prevent="reset_password">
              ...
              <div class="field">
                <div class="control has-icons-left">
                  ...
                  <input class="input is-medium" type="email" placeholder="Email" v-model="user_email">
                </div>
              </div>
              <div class="field">
                <div class="control has-icons-left">
                  ...
                  <input class="input is-medium" type="email" placeholder="Confirm Email" v-model="user_reemail">
                </div>
              </div>
...
export default{
  ...
  methods:{
    reset_password(){
      if(this.user_email && this.user_reemail && this.user_reemail === this.user_email){
       axios.post('auth/users/reset_password/',{email:this.user_email}).then(response=>{
